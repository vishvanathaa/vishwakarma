    ...
    <v-card class="mx-auto containerRotate9 pa-0" color="grey lighten-4">
          ...
          <div class="text-uppercase font-weight-black text-center headlineText mt-1 pa-0">
            ...
            <span class="text-uppercase font-weight-regular text-center font-sub-title">{{ getEntryTime() }}
              ...
              <div class="row justify-center">
                <div class="pa-1">
                  <v-chip color="green" text-color="white" class="mt-3 pb-0">
                    FREE
                    <v-icon right>
                      mdi-star
                    </v-icon>
      ...
      <v-card-text class="pa-3">
        <div>
          ...
          <v-row>
            <v-col>
              <h1 class="font-weight-black text-center mt-4 subHeader"> <span style="color:blue;">iSpent</span> has been
                rated as
                the best mobile
          ...
          <v-row>
            <v-col>
              ...
              <v-list-item-title class="text-uppercase font-weight-regular text-caption">satish gupta
                &#9733;&#9733;&#9733;&#9733;&#9733;
              </v-list-item-title>
              <div class="font-weight-bold font-feedback">
                "Very Good App...but thoda sa modify kariye...jaisa income add karna...hr monthly budget add karna..."
              </div>
            </v-col>
            <v-col>
              <v-list-item-avatar color="grey darken-3">
              ...
              <v-list-item-title class="text-uppercase font-weight-regular text-caption">ARJUN KUMAR MAJHI
                &#9733;&#9733;&#9733;&#9733;&#9733;
              </v-list-item-title>
              <div class="font-weight-bold font-feedback">
                "Excellent"
            ...
            <v-col>
              ...
              <v-list-item-title class="text-uppercase font-weight-regular text-caption">Vijay kumar Shetty
                &#9733;&#9733;&#9733;&#9733;&#9733;
              </v-list-item-title>
              <div class="font-weight-bold font-feedback">
                "Superb app. Thanks Vishwa for developing wonderful app."
              </div>
            </v-col>
          </v-row>
          <v-row>
